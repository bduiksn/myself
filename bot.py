...
def self_guide_pages():
    """هر قابلیت راهنما یک ورودی مستقل دارد؛ منوی قابلیت‌ها دو ستونه است."""
    return [
        ("🕐 ساعت روی نام",
         "🕐 <b>ساعت روی نام</b>\n\n"
         "ساعت ایران را روی نام پروفایل می‌گذارد.\n\n"
         "برای فعال‌سازی از پنل سلف، گزینه «🕐 ساعت» را روشن کن."),
        ("🔤 فونت ساعت",
         "🔤 <b>فونت ساعت</b>\n\n"
         "ظاهر اعداد ساعت روی نام پروفایل را شخصی‌سازی می‌کند.\n\n"
         "از پنل سلف روی «🔤 فونت» بزن و فونت دلخواه را انتخاب کن."),
        ("🅵 فونت فارسی",
         "🅵 <b>فونت فارسی</b>\n\n"
         "ظاهر متن‌های فارسی ارسالی را شخصی‌سازی می‌کند.\n\n"
         "از پنل سلف گزینه «🅵 فارسی» را روشن یا خاموش کن."),
        ("🔤 فونت انگلیسی",
         "🔤 <b>فونت انگلیسی</b>\n\n"
         "ظاهر متن‌های انگلیسی را شخصی‌سازی می‌کند.\n\n"
         "از پنل سلف روی «🔤 انگلیسی» بزن و فونت را انتخاب کن."),
        ("🌐 ترجمه",
         "🌐 <b>ترجمه</b>\n\n"
         "ترجمه متن‌های ارسالی به انگلیسی را فعال می‌کند.\n\n"
         "از پنل سلف گزینه «🌐 ترجمه» را روشن کن."),
        ("👁 سین",
         "👁 <b>سین</b>\n\n"
         "پیام‌های ورودی را به‌صورت خودکار خوانده‌شده می‌کند.\n\n"
         "از پنل سلف «👁 سین» را روشن یا خاموش کن."),
        ("⌨️ تایپینگ",
         "⌨️ <b>تایپینگ</b>\n\n"
         "هنگام پردازش پیام، وضعیت تایپ‌کردن را نمایش می‌دهد.\n\n"
         "از پنل سلف «⌨️ تایپینگ» را روشن یا خاموش کن."),
        ("🎮 بازی",
         "🎮 <b>بازی</b>\n\n"
         "وضعیت بازی را هنگام فعالیت سلف نمایش می‌دهد.\n\n"
         "از پنل سلف «🎮 بازی» را روشن یا خاموش کن."),
        ("💬 پاسخ خودکار",
         "💬 <b>پاسخ خودکار</b>\n\n"
         "<code>پاسخ خودکار روشن</code>\n"
         "<code>پاسخ خودکار جدید سلام</code>\n\n"
         "روی متن پاسخ ریپلای کن:\n"
        ...
        ("🎙️ ویس به متن",
         "🎙️ <b>تبدیل ویس به متن</b>\n\n"
         "روی ویس ریپلای کن و دستور مربوط به متن را بفرست:\n"
         "<code>متن</code>\n\n"
         "در راهنمای فعلی قابلیت به‌صورت «متن + ریپلی روی ویس» معرفی شده است."),
        ("🖼️ OCR تصویر",
         "🖼️ <b>OCR</b>\n\n"
         "با اجرای قابلیت OCR روی تصویر، متن موجود در تصویر استخراج می‌شود.\n\n"
         "راهنمای فعلی آن را به‌صورت «OCR روی تصویر» معرفی می‌کند."),
        ("🎵 تبدیل رسانه",
         "🎵 <b>تبدیل رسانه</b>\n\n"
        ...
        ("📥 دانلود",
         "📥 <b>دانلود</b>\n\n"
         "روی پیام موردنظر ریپلای کن و دستور زیر را بفرست:\n"
         "<code>دانلود</code>"),
        ("💾 ذخیره چنل",
         "💾 <b>ذخیره چنل</b>\n\n"
         "از پنل روی «💾 ذخیره چنل» بزن.\n"
         "سپس چنل، نوع مدیا و تعداد را انتخاب کن و تأیید کن."),
        ("🤖 تبچی / بنر",
         "🤖 <b>تبچی / ساخت بنر</b>\n\n"
        ...
        ("⏱ زمان و ارسال بنر",
         ...
         "ارسال بنر فقط با اکانت SELF انجام می‌شود.\n\n"
         "ارسال فوری به پیوی‌های اخیر:\n"
        ...
        ("📢 فعال‌سازی کامنت",
         "📢 <b>فعال‌سازی کامنت اول برای کانال</b>\n\n"
...
def self_guide_text(page=1):
    pages = self_guide_pages()
    page = max(1, min(int(page), len(pages)))
    return pages[page - 1][1]

def self_guide_menu_text():
    return (
        "📚 <b>راهنمای کامل سلف 𝗛𝘂𝘀𝘁𝗲𝗥𝗜𝗫</b>\n\n"
        "هر قابلیت را جداگانه انتخاب کن تا آموزش و تمام دستورهای همان بخش نمایش داده شود.\n\n"
        "👇 <b>قابلیت موردنظر را انتخاب کن:</b>"
    )

def self_guide_buttons(uid, page=1):
    pages = self_guide_pages()
    rows = []
    for idx, (title, _) in enumerate(pages, 1):
        if idx % 2 == 1:
            rows.append([btn(title, _self_cb(uid, f"guide_feature:{idx}"), "primary")])
        else:
            rows[-1].append(btn(title, _self_cb(uid, f"guide_feature:{idx}"), "primary"))
    rows.append([btn("🔙 بازگشت", _self_cb(uid, "panel"), "primary")])
    return rows

def self_guide_detail_buttons(uid, page):
    rows = [[btn("🔙 بازگشت به لیست قابلیت‌ها", _self_cb(uid, "guide"), "primary")]]
    return rows
...
async def handle_self_panel_callback(event):
    ...
    if action == "guide":
        try:
            await event.edit(
                self_guide_menu_text(),
                parse_mode="html",
                buttons=self_guide_buttons(uid),
            )
        except Exception as exc:
    ...
    if action.startswith("guide_feature:"):
        try:
        ...
        if not 1 <= page <= len(pages):
            await safe_answer(event, "❌ قابلیت نامعتبر است.", True)
            return True
        try:
            await event.edit(
                self_guide_text(page),
                parse_mode="html",
                buttons=self_guide_detail_buttons(uid, page),
            )
        except Exception as exc:
            print(f"[SELF {uid}] guide feature {page} callback failed: {exc}")
            await safe_answer(event, "❌ آموزش باز نشد؛ دوباره تلاش کن.", True)
        return True
    if action == "ping":
...
async def inline_query_handler(event):
    ...
    if query == "راهنما":
        result = event.builder.article(
            title="📚 راهنمای سلف",
            description="راهنمای کامل و دکمه‌ای سلف با آموزش جداگانه هر قابلیت.",
