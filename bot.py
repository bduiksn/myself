...
SELF_FEATURE_GUIDES = {
    "clock": (
        "🕐 <b>ساعت روی نام</b>\n\n"
        "این قابلیت ساعت ایران را به انتهای نام پروفایل SELF اضافه می‌کند و در حالت فعال، "
        "ساعت را به‌صورت دوره‌ای به‌روزرسانی می‌کند.\n\n"
        "<b>روشن / خاموش:</b>\n"
        "<code>ساعت روشن</code>\n"
        "<code>ساعت خاموش</code>\n\n"
        "<b>تغییر فونت ساعت:</b>\n"
        "<code>فونت ساعت عادی</code>\n"
        "<code>فونت ساعت بولد</code>\n"
        "<code>فونت ساعت دوبل</code>\n"
        "<code>فونت ساعت سانس</code>\n"
        "<code>فونت ساعت سانس بولد</code>\n"
        "<code>فونت ساعت مونو</code>\n"
        "<code>فونت ساعت فول</code>\n"
        "<code>فونت ساعت دایره</code>\n"
        "<code>فونت ساعت منفی</code>\n"
        "<code>فونت ساعت بالانویس</code>\n"
        "<code>فونت ساعت زیرنویس</code>\n"
        "<code>فونت ساعت فارسی</code>\n"
        "<code>فونت ساعت عربی</code>\n"
        "<code>فونت ساعت هندی</code>\n\n"
        "💡 فرمان باید با همین ساختار ارسال شود؛ جمله‌های محاوره‌ای مثل «فونت ساعتت رو عوض کن» فرمان محسوب نمی‌شوند."
    ),

    "fonts": (
        "🔤 <b>فونت‌ها</b>\n\n"
        "<b>🕐 فونت ساعت</b>\n"
        "<code>فونت ساعت عادی</code> • <code>فونت ساعت بولد</code> • <code>فونت ساعت دوبل</code>\n"
        "<code>فونت ساعت سانس</code> • <code>فونت ساعت سانس بولد</code> • <code>فونت ساعت مونو</code>\n"
        "<code>فونت ساعت فول</code> • <code>فونت ساعت دایره</code> • <code>فونت ساعت منفی</code>\n"
        "<code>فونت ساعت بالانویس</code> • <code>فونت ساعت زیرنویس</code>\n"
        "<code>فونت ساعت فارسی</code> • <code>فونت ساعت عربی</code> • <code>فونت ساعت هندی</code>\n\n"
        "<b>🇬🇧 فونت انگلیسی</b>\n"
        "<code>فونت انگلیسی عادی</code>\n"
        ...
        "فونت انگلیسی روی متن‌های انگلیسی اثر می‌گذارد و تنظیمات آن از پنل نیز قابل تغییر است."
    ),

    "translate": (
        "🌐 <b>ترجمه خودکار</b>\n\n"
        "با فعال بودن این قابلیت، متن‌های خروجی SELF قبل از ارسال به انگلیسی ترجمه می‌شوند.\n\n"
        "روشن: <code>ترنسلیت روشن</code>\n"
        "خاموش: <code>ترنسلیت خاموش</code>\n\n"
        "همین تنظیم از دکمه ترجمه در پنل هم قابل کنترل است."
    ),

    "presence": (
        "👁 <b>سین / تایپینگ / بازی</b>\n\n"
        "<b>👁 سین خودکار</b>\n"
        "<code>سین روشن</code>\n"
        "<code>سین خاموش</code>\n"
        "در حالت روشن، پیام‌های دریافتی خوانده می‌شوند.\n\n"
        "<b>⌨️ تایپینگ</b>\n"
        "<code>تایپینگ روشن</code>\n"
        "<code>تایپینگ خاموش</code>\n"
        "حالت تایپ‌کردن را در گفتگوها شبیه‌سازی می‌کند.\n\n"
        "<b>🎮 حالت بازی</b>\n"
        "<code>حالت بازی روشن</code>\n"
        "<code>حالت بازی خاموش</code>\n"
        "حالت بازی تلگرام را به‌عنوان وضعیت حضور ارسال می‌کند.\n\n"
        "هر سه قابلیت مستقل‌اند و از پنل نیز قابل تغییر هستند."
    ),

    "autoreply": (
        "💬 <b>پاسخ خودکار — آموزش کامل</b>\n\n"
        "پاسخ خودکار برای زمانی است که یک کلمه یا عبارت مشخص از طرف مقابل دریافت شود و SELF "
        "پاسخ ذخیره‌شده همان کلید را ارسال کند. این قابلیت در پیام‌های خصوصی ورودی کار می‌کند.\n\n"
        "<b>مرحله ۱ — ساخت کلید</b>\n"
        "<code>پاسخ خودکار جدید سلام</code>\n"
        "این دستور کلید «سلام» را ثبت می‌کند. کلید می‌تواند یک کلمه یا عبارت باشد.\n\n"
        "<b>مرحله ۲ — تعیین متن پاسخ</b>\n"
        "اول متن پاسخ دلخواهت را بفرست، سپس روی همان پیام ریپلای کن و بنویس:\n"
        "<code>ذخیره پاسخ خودکار سلام</code>\n"
        "متن پیام ریپلای‌شده به‌عنوان پاسخ کلید «سلام» ذخیره می‌شود.\n\n"
        "<b>مرحله ۳ — فعال‌سازی</b>\n"
        "<code>پاسخ خودکار روشن</code>\n\n"
        "<b>خاموش کردن</b>\n"
        "<code>پاسخ خودکار خاموش</code>\n\n"
        "<b>حذف یک کلید</b>\n"
        "<code>حذف پاسخ خودکار سلام</code>\n\n"
        "<b>مشاهده همه کلیدها و پاسخ‌ها</b>\n"
        "<code>لیست پاسخ خودکار</code>\n\n"
        "⚠️ پاسخ خودکار فقط وقتی اجرا می‌شود که متن دریافتی دقیقاً با یکی از کلیدهای ثبت‌شده مطابقت داشته باشد.\n"
        "⚠️ برای ذخیره پاسخ، ریپلای به یک پیام متنی الزامی است.\n"
        "💡 مثال کامل: «سلام» ← کلید / «سلام، خوش اومدی 🌹» ← پاسخ ذخیره‌شده."
    ),

    "reaction": (
        "❤️ <b>ریاکشن خودکار</b>\n\n"
        "برای یک کاربر مشخص می‌توانی تعیین کنی که SELF روی پیام‌های بعدی او چه ریاکشنی بزند.\n\n"
        "<b>فعال‌سازی</b>\n"
        "روی پیام همان کاربر ریپلای کن و یکی از این نمونه‌ها را بفرست:\n"
        "<code>ریاکشن ❤️</code>\n"
        "<code>ریاکشن 🔥</code>\n"
        "<code>ریاکشن 😂</code>\n\n"
        "ریاکشن همان لحظه نیز روی پیام ریپلای‌شده آزمایش می‌شود؛ اگر تلگرام آن ایموجی را نپذیرد، تنظیم ذخیره نمی‌شود.\n\n"
        "<b>حذف برای همان کاربر</b>\n"
        "روی پیام او ریپلای کن و:\n"
        "<code>حذف ریاکشن</code>\n"
        "یا <code>ریاکشن خاموش</code>\n\n"
        "⚠️ جمله‌هایی مثل «ریاکشن بزن» فرمان محسوب نمی‌شوند؛ فرمان ریاکشن باید همراه یک ایموجی معتبر باشد."
    ),

    "lock": (
        "🔒 <b>قفل چت</b>\n\n"
        "این قابلیت برای یک کاربر مشخص در پیوی فعال می‌شود و پیام‌های بعدی او را دوطرفه حذف می‌کند.\n\n"
        "<b>فعال‌سازی</b>\n"
        "در پیوی، روی پیام همان کاربر ریپلای کن و:\n"
        "<code>قفل چت</code>\n"
        "یا <code>قفل چت + ریپلای</code>\n\n"
        "<b>باز کردن قفل</b>\n"
        "روی پیام همان کاربر ریپلای کن و:\n"
        "<code>بازکردن قفل چت</code>\n"
        "یا <code>باز کردن قفل چت</code>\n"
        "یا <code>قفل چت خاموش</code>\n\n"
        "⚠️ این قابلیت فقط برای پیوی طراحی شده و هدف آن کاربری است که روی پیامش ریپلای کرده‌ای."
    ),

    "media": (
        "🎙️ <b>رسانه و تبدیل‌ها</b>\n\n"
        "<b>🎙️ ویس به متن</b>\n"
        "روی ویس یا فایل صوتی ریپلای کن و:\n"
        "<code>متن</code>\n"
        "یا <code>متن + ریپلی</code>\n"
        "متن صوت با موتور تبدیل گفتار به متن پردازش می‌شود.\n\n"
        "<b>🖼️ OCR</b>\n"
        "روی تصویر ریپلای کن و:\n"
        "<code>OCR</code>\n"
        "یا <code>او سی آر</code>\n\n"
        "<b>🎵 تبدیل‌های صوتی/ویدیویی</b>\n"
        "<code>ویس به mp3</code> ← ویس به MP3\n"
        "<code>mp3 به ویس</code> ← MP3 به ویس\n"
        "<code>ویدیو به ویس</code> ← ویدیو به ویس\n"
        "<code>ویدیو به mp3</code> ← ویدیو به MP3\n\n"
        "برای تبدیل فایل، دستور باید روی فایل موردنظر ریپلای شود. تبدیل‌ها با نوار پیشرفت انجام می‌شوند."
    ),

    "files": (
        "📦 <b>فایل و دانلود</b>\n\n"
        "<b>استخراج ZIP/RAR</b>\n"
        "روی فایل ZIP یا RAR ریپلای کن و:\n"
        "<code>استخراج</code>\n\n"
        "<b>دانلود / ذخیره پیام یا مدیا</b>\n"
        "روی پیام موردنظر ریپلای کن و:\n"
        "<code>دانلود</code>\n\n"
        "💡 در هر دو مورد، ریپلای به فایل یا پیام هدف لازم است."
    ),

    "channel_save": (
        "💾 <b>ذخیره چنل</b>\n\n"
        "این بخش از پنل انجام می‌شود و عملیات با همان اکانت SELF اجرا می‌شود.\n\n"
        "<b>مراحل کار:</b>\n"
        "۱) از پنل وارد «ذخیره چنل» شو.\n"
        "۲) کانال موردنظر را انتخاب کن.\n"
        "۳) نوع مدیا/محتوای موردنظر را انتخاب کن.\n"
        "۴) تعداد پیام‌هایی که باید ذخیره شوند را مشخص کن.\n"
        "۵) دکمه تأیید را بزن.\n"
        "۶) عملیات ذخیره‌سازی شروع می‌شود و وضعیت پیشرفت نمایش داده می‌شود.\n\n"
        "⚠️ این راهنما فقط توضیح استفاده از قابلیت موجود است و منطق اجرای ذخیره چنل را تغییر نمی‌دهد."
    ),

    "tabchi": (
        "📢 <b>تبچی / مدیریت بنر — آموزش کامل</b>\n\n"
        "تبچی برای ساخت یک بنر از روی پیام، تعیین گروه‌های مقصد، تعیین فاصله زمانی و ارسال خودکار آن استفاده می‌شود. "
        "ارسال‌ها با اکانت SELF انجام می‌شوند، نه BOT.\n\n"
        "<b>① ساخت بنر</b>\n"
        "روی پیام موردنظر ریپلای کن:\n"
        "<code>تنظیم بنر فور</code>\n"
        "→ پیام را به‌صورت فوروارد ارسال می‌کند.\n\n"
        "<code>تنظیم بنر کپی</code>\n"
        "→ پیام را به‌صورت کپی ارسال می‌کند؛ برای مدیای کپی، فایل آن نیز ذخیره می‌شود.\n\n"
        "بعد از ساخت، بنر یک شماره می‌گیرد؛ مثلاً بنر شماره <code>۱</code>.\n\n"
        "<b>② تعیین فاصله ارسال</b>\n"
        "<code>تنظیم عدد بنر ۱ ۳۰ دقیقه</code>\n"
        "یعنی بنر شماره ۱ هر ۳۰ دقیقه برای مقصدهای ثبت‌شده ارسال شود.\n"
        "عدد دقیقه باید حداقل ۱ باشد.\n\n"
        "<b>③ افزودن همین گروه به مقصد بنر</b>\n"
        "داخل همان گروه اجرا کن:\n"
        "<code>تنظیم گپ هدف بنر ۱</code>\n"
        "گروه فعلی به مقصدهای بنر ۱ اضافه می‌شود.\n\n"
        "<b>④ حذف همین گروه از مقصد</b>\n"
        "داخل همان گروه:\n"
        "<code>حذف گپ هدف بنر ۱</code>\n\n"
        "<b>⑤ قراردادن تمام گروه‌های قابل دسترسی به‌عنوان مقصد</b>\n"
        "<code>تنظیم هدف بنر ۱ تمام گپ ها</code>\n"
        "SELF گروه‌های قابل دسترسی خود را بررسی کرده و آن‌ها را مقصد بنر می‌کند.\n\n"
        "<b>⑥ روشن / خاموش کردن ارسال خودکار</b>\n"
        "<code>تبچی روشن</code>\n"
        "<code>تبچی خاموش</code>\n"
        "با روشن کردن تبچی، بنرهای فعال و مقصدهای ثبت‌شده وارد چرخه ارسال خودکار می‌شوند. "
        "هنگام روشن‌کردن، ارسال فوری اولیه نیز طبق منطق فعلی انجام می‌شود.\n\n"
        "<b>⑦ مشاهده وضعیت</b>\n"
        "<code>وضعیت تبچی</code>\n"
        "وضعیت روشن/خاموش و تعداد بنرهای ثبت‌شده را نشان می‌دهد.\n\n"
        "<b>⑧ مشاهده لیست بنرها</b>\n"
        "<code>لیست بنر هام</code>\n"
        "شماره، نوع فوروارد/کپی، فاصله زمانی و تعداد مقصدهای هر بنر را نشان می‌دهد.\n\n"
        "<b>⑨ حذف یک بنر</b>\n"
        "<code>حذف بنر ۱</code>\n"
        "بنر شماره ۱ و فایل رسانه‌ای ذخیره‌شده مرتبط با آن حذف می‌شود.\n\n"
        "<b>⑩ پاکسازی همه بنرها</b>\n"
        "<code>پاکسازی لیست بنر ها</code>\n"
        "تمام بنرهای ثبت‌شده و فایل‌های رسانه‌ای مربوط به آن‌ها پاک می‌شوند.\n\n"
        "<b>⑪ ارسال فوری به پیوی‌های اخیر</b>\n"
        "<code>فور بنر در ۲۰ پیوی اخیر</code>\n"
        "بنر را همان لحظه برای ۲۰ پیوی اخیر ارسال می‌کند. عدد پیوی را می‌توان تغییر داد.\n\n"
        "💡 <b>ترتیب پیشنهادی:</b> روی پیام ریپلای → ساخت بنر → تعیین مقصد → تعیین زمان → <code>تبچی روشن</code>.\n"
        "⚠️ برای اجرای ارسال‌ها، SELF باید فعال باشد."
    ),

    "spam": (
        "🔁 <b>تکرار پیام</b>\n\n"
        "روی پیام موردنظر ریپلای کن و تعداد تکرار را مشخص کن:\n"
        "<code>تکرار 10</code>\n"
        "<code>تکرار 160</code>\n\n"
        "محدوده فعلی تعداد: ۱ تا ۱۰۰۰.\n"
        "⚠️ استفاده از تعدادهای بالا ممکن است با محدودیت‌های تلگرام مواجه شود."
    ),

    "comments": (
        "💬 <b>کامنت اول کانال — آموزش کامل</b>\n\n"
        "این قابلیت برای ارسال خودکار یک متن به Discussion مربوط به پست‌های کانال تنظیم‌شده است.\n\n"
        "<b>① ثبت کانال</b>\n"
        "در پیوی SELF بنویس:\n"
        "<code>تنظیم کامنت اول @channel</code>\n"
        "کانال باید Discussion متصل داشته باشد. بعد از ثبت، همان کانال به‌عنوان هدف انتخاب می‌شود.\n\n"
        "<b>② تعیین متن کامنت</b>\n"
        "روی پیام متنی موردنظر ریپلای کن و:\n"
        "<code>تنظیم کامنت</code>\n"
        "همین کار متن کامنت را ذخیره کرده و قابلیت کانال را فعال می‌کند.\n\n"
        "<b>③ مشاهده لیست کانال‌ها</b>\n"
        "<code>لیست کامنت</code>\n\n"
        "<b>④ حذف تنظیمات یک کانال</b>\n"
        "<code>حذف کامنت اول @channel</code>\n\n"
        "<b>⑤ پاکسازی همه تنظیمات</b>\n"
        "<code>پاکسازی لیست کامنت</code>\n\n"
        "💡 اگر کانال Discussion متصل نداشته باشد، تنظیم آن انجام نمی‌شود."
    ),

    "secretary": (
        "🤵 <b>منشی — آموزش کامل</b>\n\n"
        "منشی برای زمانی است که نمی‌خواهی به هر پیام پیوی فوراً جواب بدهی. یک پاسخ متنی یا مدیایی را ذخیره می‌کنی؛ "
        "سپس SELF در پیوی‌ها به‌صورت خودکار و با فاصله زمانی مشخص برای هر مخاطب پاسخ می‌دهد.\n\n"
        "<b>① تنظیم پاسخ منشی</b>\n"
        "ابتدا پیام پاسخ دلخواهت را بفرست؛ سپس روی همان پیام ریپلای کن و یکی از این‌ها را بفرست:\n"
        "<code>تنظیم منشی</code>\n"
        "<code>تنظیم منشی + ریپلای</code>\n"
        "<code>تنظیم منشی ریپلای</code>\n\n"
        "پاسخ می‌تواند <b>متنی یا مدیا</b> باشد. اگر روی عکس/فایل/مدیا ریپلای کنی، فایل برای استفاده بعدی ذخیره می‌شود.\n\n"
        "<b>② فعال کردن منشی</b>\n"
        "<code>منشی روشن</code>\n"
        "اگر هنوز پاسخ منشی ذخیره نشده باشد، فعال‌سازی انجام نمی‌شود.\n\n"
        "<b>③ خاموش کردن منشی</b>\n"
        "<code>منشی خاموش</code>\n\n"
        "<b>④ تعیین فاصله پاسخ</b>\n"
        "<code>تنظیم زمان منشی ۱۵</code>\n"
        "عدد برحسب دقیقه است و فقط از <b>۵ تا ۶۰ دقیقه</b> مجاز است.\n\n"
        "<b>نحوه عملکرد زمان‌بندی:</b>\n"
        "وقتی منشی روشن باشد، برای هر مخاطب پیوی جداگانه زمان آخرین پاسخ نگه‌داری می‌شود. "
        "بنابراین پیام‌های پشت‌سرهم یک نفر باعث ارسال پاسخ منشی در هر پیام نمی‌شوند؛ تا پایان فاصله تعیین‌شده، پاسخ دوباره ارسال نمی‌شود.\n\n"
        "<b>محدوده استفاده:</b>\n"
        "منشی فقط روی پیام‌های ورودی <b>پیوی</b> فعال است و روی گروه‌ها و کانال‌ها اجرا نمی‌شود.\n\n"
        "💡 <b>مثال:</b> پاسخ «سلام، فعلاً در دسترس نیستم 🌹» را تنظیم کن، منشی را روشن کن و زمان را روی ۱۵ دقیقه بگذار؛ "
        "هر مخاطب در شروع بازه پاسخ خودکار را دریافت می‌کند و تا ۱۵ دقیقه دوباره همان پاسخ را دریافت نخواهد کرد."
    ),

    "group": (
        "🛡 <b>مدیریت گروه</b>\n\n"
        "<b>📌 پین پیام</b>\n"
        "داخل گروه روی پیام ریپلای:\n"
        "<code>پین</code>\n"
        "<code>پین + ریپلای</code>\n\n"
        "<b>📌 حذف پین</b>\n"
        "<code>حذف پین</code>\n"
        "<code>حذف پین + ریپلای</code>\n\n"
        "<b>🚫 بن کاربر</b>\n"
        "روی پیام کاربر ریپلای:\n"
        "<code>بن</code>\n"
        "یا <code>سیک</code>\n"
        "یا <code>بن + ریپلای</code>\n"
        "یا <code>سیک + ریپلای</code>\n\n"
        "<b>✅ آن‌بن</b>\n"
        "<code>آن بن</code>\n"
        "یا <code>ان بن</code>\n"
        "یا <code>آن‌بن</code>\n\n"
        "⚠️ برای پین و مدیریت دسترسی، SELF باید دسترسی ادمینی لازم را در گروه داشته باشد."
    ),

    "globalban": (
        "🚫 <b>بن سراسری</b>\n\n"
        "بن سراسری یک لیست مستقل برای SELF است و کاربر ثبت‌شده را در گروه‌ها شناسایی می‌کند.\n\n"
        "<b>ثبت با یوزرنیم/شناسه</b>\n"
    ...
    "tag": (
        "🏷 <b>تگ اعضای گروه</b>\n\n"
        "این قابلیت اعضای گروه را به‌صورت دسته‌ای منشن می‌کند.\n\n"
        "<b>تعداد مشخص</b>\n"
        "<code>تگ 20</code>\n"
        "یعنی تا ۲۰ عضو را تگ کن.\n\n"
        "<b>تگ همه</b>\n"
        "<code>همه</code>\n\n"
        "محدوده تعداد مشخص: ۱ تا ۱۰۰۰.\n"
        "ربات‌ها و خود صاحب SELF از لیست تگ حذف می‌شوند.\n"
        "اگر روی یک پیام ریپلای کرده باشی، خروجی تگ به همان پیام متصل می‌شود.\n\n"
        "⚠️ فقط داخل گروه قابل استفاده است."
    ),

    "currency": (
        "💱 <b>نرخ ارز و رمزارز</b>\n\n"
        "برای دریافت نرخ از دستور قیمت استفاده کن:\n"
        "<code>قیمت BTC</code>\n"
        "<code>قیمت ETH</code>\n"
        "<code>قیمت SOL</code>\n"
        "<code>قیمت USDT</code>\n\n"
        "قیمت از سرویس عمومی دریافت می‌شود و در صورت خطای سرویس اصلی، مسیر جایگزین در نظر گرفته شده است."
    ),

    "logo": (
        "🎨 <b>لوگوساز</b>\n\n"
        "برای ساخت لوگو، شماره قالب و متن را مشخص کن:\n"
        "<code>لوگو 12 HusteRIX</code>\n\n"
        "عدد ۱۲ نمونه شماره قالب است؛ شماره باید در محدوده قالب‌های موجود باشد.\n"
        "متن بعد از شماره قالب، محتوای لوگوی درخواستی است."
    ),

    "general": (
        "🧩 <b>دستورات عمومی SELF</b>\n\n"
        "<b>📚 راهنما</b>\n"
        "<code>راهنما</code>\n"
        "راهنمای شیشه‌ای قابلیت‌ها را باز می‌کند.\n\n"
        "<b>⚙️ پنل</b>\n"
        "<code>پنل</code>\n"
        "پنل شیشه‌ای تنظیمات SELF را باز می‌کند.\n\n"
        "<b>🏓 پینگ</b>\n"
        "<code>پینگ</code>\n"
        "تاخیر اجرای فرمان را نمایش می‌دهد.\n\n"
        "<b>🎲 تاس</b>\n"
        "<code>تاس 1</code> تا <code>تاس 6</code>\n"
        "یک تاس واقعی تلگرام با مقدار درخواستی تولید می‌کند.\n\n"
        "<b>🧑‍💻 هک نمایشی</b>\n"
        "<code>هک</code>\n"
        "افکت نمایشی هک را اجرا می‌کند.\n\n"
        "<b>👥 ساخت گروه</b>\n"
        "<code>ساخت گروه نام گروه</code>\n\n"
        "<b>📢 ساخت چنل</b>\n"
        "<code>ساخت چنل نام چنل</code>\n\n"
        "<b>👤 کپی پروفایل</b>\n"
        "<code>کپی پروفایل</code>\n"
        "اطلاعات پروفایل را برای قابلیت بازگردانی ذخیره می‌کند.\n\n"
        "<b>↩️ بازگردانی پروفایل</b>\n"
        "<code>حذف کپی پروفایل</code>\n"
        "پروفایلی را که قبلاً برای بازگردانی ذخیره شده، برمی‌گرداند."
    ),

    "sticker": (
        "🖼️ <b>استیکر و تبدیل عکس</b>\n\n"
        "<b>عکس → استیکر</b>\n"
        "<code>استیکر</code>\n"
        "<code>تبدیل عکس به استیکر</code>\n"
        "<code>عکس به استیکر</code>\n\n"
        "اگر می‌خواهی دستور روی پیام ریپلای‌شده عمل کند:\n"
        "<code>استیکر + ریپلای</code>\n"
        "<code>استیکر ریپلای</code>\n\n"
        "<b>استیکر → عکس</b>\n"
        "<code>عکس</code>\n"
        "<code>تبدیل استیکر به عکس</code>\n"
        "<code>استیکر به عکس</code>\n\n"
        "حالت ریپلای‌شده:\n"
        "<code>عکس + ریپلای</code>\n"
        "<code>عکس ریپلای</code>\n"
        "<code>استیکر به عکس + ریپلای</code>\n\n"
        "💡 در حالت‌های ریپلای، رسانه باید در پیام ریپلای‌شده قرار داشته باشد."
    ),
}
...
def self_feature_guide_buttons(uid):
    labels = [
        ...
        ("🧩 دستورات عمومی", "general"), ("🖼️ استیکر", "sticker"),
    ]
    rows=[]
...
async def self_handle_outgoing(event, uid):
    ...
    m_auto_new = re.fullmatch(r"پاسخ خودکار جدید\s+(.+)", text, flags=re.S)
    if m_auto_new:
        keyword = m_auto_new.group(1).strip().casefold()
        if not keyword:
    ...
    m_auto_save = re.fullmatch(r"ذخیره پاسخ خودکار\s+(.+)", text, flags=re.S)
    if m_auto_save:
        if not event.is_reply:
            await event.edit("❌ این دستور باید روی پیام پاسخ ریپلای شود.")
            return
        keyword = m_auto_save.group(1).strip().casefold()
        replied = await event.get_reply_message()
    ...
    m_auto_delete = re.fullmatch(r"حذف پاسخ خودکار\s+(.+)", text, flags=re.S)
    if m_auto_delete:
        keyword = m_auto_delete.group(1).strip().casefold()
        mapping = self_auto_reply_map(uid)
    ...
    m_clock_font = re.fullmatch(r"فونت ساعت(?:\s+(.+))?", text, flags=re.S)
    if m_clock_font:
        raw_value = (m_clock_font.group(1) or "").strip().casefold()
        value = SELF_FONT_ALIASES.get(raw_value, raw_value)
    ...
    m_english_font = re.fullmatch(r"فونت انگلیسی(?:\s+(.+))?", text, flags=re.S)
    if m_english_font:
        raw_value = (m_english_font.group(1) or "").strip().casefold()
        value = SELF_ENGLISH_FONT_ALIASES.get(raw_value, raw_value)
    ...
    if reaction_match:
        ...
        # Only emoji/symbol sequences are valid here. This prevents normal
        # sentences such as "ریاکشن بزن فراموش نشه" from becoming commands.
        def _is_reaction_emoji_sequence(value):
            if not value or len(value) > 32:
                return False
            allowed_categories = {"Mn", "Mc", "Me", "Cf", "Sk", "So"}
            for ch in value:
                if unicodedata.category(ch) in allowed_categories:
                    continue
                if ch in "0123456789#*\ufe0f\u20e3":
                    continue
                return False
            return True

        if not _is_reaction_emoji_sequence(emoji):
            return
        if not event.is_reply:
